 ...
 * @author thomas
 */
public class Rasher extends Dog implements Animals {
    ...
    public Rasher(int age, String gender, String nickname, int strength, int health, String name) {
        this.age = age;
        this.gender = gender;
    ...
    @Override
    public void Speak() {
        System.out.println(getName() + "says rash rash ");
    }
